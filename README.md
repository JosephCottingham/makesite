...
[![Go Report Card](https://goreportcard.com/badge/github.com/JosephCottingham/makesite)](https://goreportcard.com/report/github.com/JosephCottingham/makesite)
...
- [x] Add any third party library to your project to enhance it's functionality. Some ideas you might consider include **_(CHOOSE ONLY ONE)_**:
    ...
    - [x] **_FILL IN THE BLANK_**: `I will use the Cloud Translation API library. The documentation is located at https://pkg.go.dev/cloud.google.com/go/translate@v1.2.0#section-documentation. My goal is to use it to translate the page with Google Translate.`
- [x] **Add, commit, and push to GitHub**.
